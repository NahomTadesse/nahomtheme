...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$nahomtheme_description = get_bloginfo( 'description', 'display' );
			if ( $nahomtheme_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $nahomtheme_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
